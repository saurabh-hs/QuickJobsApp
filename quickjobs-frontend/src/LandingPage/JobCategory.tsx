...
const JobCategory=()=>{
    return (
        <div className="mt-20">
            ...
            <Carousel slideSize="22%" slideGap="md" loop className='focus-visible:[&_button]:!outline-none [&_button]:!bg-cloud-burst-400 [&_button]:!border-none' nextControlIcon={<IconArrowRight className='h-8 w-8' />}

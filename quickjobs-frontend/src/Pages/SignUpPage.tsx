import { IconArrowLeft, IconWorldDownload } from "@tabler/icons-react";
...
const SignUpPage=()=> {
    ...
    return <div className="min-h-[90vh] bg-cloud-burst-50 font-['Poppins'] p-4 overflow-hidden relative">
        <Button size="sm" className="!absolute left-5 z-10" onClick={() => navigate("/")} my="lg" color="cloud-burst.8" leftSection={<IconArrowLeft size={20} />} variant="light">Home</Button>

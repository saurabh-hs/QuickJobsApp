export const companies = ["Google", "Amazon", "Figma", "Netflix", "Meta", "Microsoft", "Pinterest", "Slack", "Spotify", "Oracle", "Walmart", "TCS"];

export const jobCategory = [
    {
        "name": "Arts & Design",
        "desc": "Create visual content for branding and media",
        "status": "500+ new job posted"
    },
    {
        "name": "UI-UX Designer",
        "desc": "Design user interfaces and enhance user experience",
        "status": "800+ new job posted"
    },
    {
        "name": "Content Writing",
        "desc": "Write and edit content for various platforms",
        "status": "1.5k+ new job posted"
    },
    {
        "name": "Data Entry",
